# 📄 Operating Systems Essay — Tiểu luận Hệ điều hành [HUIT]
...
## 👨‍💻 Tác giả (Authors)
* **Trần Gia Bảo (@gibor06)** - *Lead Developer & Researcher*
* **Lê Quang Bảo** - *Collaborator*

 🎓 **Trường Đại học Công Thương TP.HCM (HUIT)**  📍 Ngành: Công Nghệ Thông Tin
...
* Hệ thống hóa kiến thức học thuật của môn **Hệ điều hành**
* Hỗ trợ học tập, ôn tập và tham khảo cho sinh viên ngành **Công Nghệ Thông Tin**
* Minh họa các cơ chế quan trọng của hệ điều hành thông qua **mã nguồn C++**
* Kết hợp giữa lý thuyết và thực hành để giúp người học tiếp cận kiến thức dễ dàng hơn
* Xây dựng một repository học thuật rõ ràng, khoa học và dễ sử dụng trên GitHub
...
Project được xây dựng cho mục đích **học tập**, **nghiên cứu học thuật** và **tham khảo tài liệu** trong môn **Hệ điều hành**.

Nếu bạn sử dụng repository này cho mục đích tham khảo hoặc phát triển thêm, vui lòng ghi nhận nguồn phù hợp với tác giả.
